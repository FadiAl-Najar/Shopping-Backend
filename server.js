...
function addFavProduct(req, res) {
  ...
  const sql = `INSERT INTO favProducts (goods_id, goods_img, goods_name, amount)
    VALUES ($1, $2, $3, $4);`;
  const values = [
    favProduct.goods_id,
    favProduct.goods_img,
    favProduct.goods_name,
    favProduct.amount,
  ];
...
function Shop(goods_id, goods_img, goods_name, amount) {
